...
const en = {
  ...
  stAnswered: 'answered',
  stResolved: 'resolved',
  openInDifit: 'Open in difit',
  copyPath: 'Copy path',
  difitNoAnchor: 'difit cannot be linked to a line, so this opens the diff - the file and line are above.',
  expand: 'Full screen',
...
const hinglish = {
  ...
  stAnswered: 'answered',
  stResolved: 'resolved',
  openInDifit: 'difit mein kholo',
  copyPath: 'Path copy karo',
  difitNoAnchor: 'difit ko line tak link nahi kar sakte, isliye ye diff kholta hai - file aur line upar likhi hai.',
  expand: 'Full screen',
  collapse: 'Exit full screen',
...
const hindi = {
  ...
  stAnswered: 'उत्तरित',
  stResolved: 'सुलझाया',
  openInDifit: 'difit में खोलें',
  copyPath: 'पथ कॉपी करें',
  difitNoAnchor: 'difit को लाइन तक लिंक नहीं किया जा सकता, इसलिए यह डिफ़ खोलता है - फ़ाइल और लाइन ऊपर लिखी है।',
  expand: 'पूरी स्क्रीन',
